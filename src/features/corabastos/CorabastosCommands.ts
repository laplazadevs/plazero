...
// Slash command definitions for this feature, collected by the entrypoint.
export const corabastosSlashCommands = [
    new SlashCommandBuilder()
        .setName(CORABASTOS_AGENDA_COMMAND)
    ...
    new SlashCommandBuilder()
        .setName(CORABASTOS_EMERGENCY_COMMAND)
    ...
    new SlashCommandBuilder()
        .setName(CORABASTOS_STATUS_COMMAND)
        .setDescription('Muestra el estado actual del corabastos'),
    new SlashCommandBuilder()
        .setName(CORABASTOS_CREATE_SESSION_COMMAND)
