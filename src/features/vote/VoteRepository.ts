...
// Row schemas for the vote tables. The `pg` driver already converts TIMESTAMP
// columns to `Date` instances and INTEGER columns to numbers.
...
export class VoteRepository extends Context.Service<VoteRepository>()('plazero/VoteRepository', {
    ...
    static readonly layer = Layer.effect(VoteRepository)(VoteRepository.make);
}
