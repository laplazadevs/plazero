...
import { calculateVoteCounts, type VoteData } from './VoteDomain.js';
import { type VoteReactionType, VoteRepository, type VoteRow } from './VoteRepository.js';
...
export class VoteManager extends Context.Service<VoteManager>()('plazero/VoteManager', {
    ...
    static readonly layer = Layer.effect(VoteManager)(VoteManager.make);
}
